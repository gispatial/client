  ...
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="notification-dropdown dropdown-custom vx-navbar-dropdown">
      ...
      <div class="notification-top text-center p-5 bg-primary text-white">
        ...
        <p class="opacity-75">Dashboard Reminder!</p>
      </div>
      ...
      unreadNotifications: [
          {
            ...
            msg      : 'Thanks for signup with us _Tripcarte.Asia',
            icon     : 'BellIcon',
          ...
          { index    : 2,
            title    : 'Outstanding Cloud Quota Reached!',
            msg      : 'Cloud have 99% payload usage.',
            icon     : 'AlertOctagonIcon',
            time     : this.randomDate({min: 1}),
            category : 'danger'
          },
          { index    : 3,
            title    : 'New Message From Underwater World Admin',
            msg      : 'Hi Tripcarte admin!',
            icon     : 'BellIcon',
